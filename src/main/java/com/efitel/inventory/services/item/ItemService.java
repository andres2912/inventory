...
public interface ItemService {
	 ...
	 * 
	 * @param items the list of {@link ItemDTO} objects containing the details of
	 *              each item to create; must not be {@code null} or empty
	 * @return a list of {@link ItemDTO} representing the created items, including
